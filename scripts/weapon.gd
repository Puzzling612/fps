...
func _build_defs() -> void:
	...
	ar.magazine_size = 30; ar.max_reserve = 90; ar.max_reserve_cap = 240
	...
	sg.damage = 11; sg.fire_interval = 0.8
	sg.magazine_size = 6; sg.max_reserve = 36; sg.max_reserve_cap = 96
	sg.reload_time = 2.6; sg.pellets = 8; sg.spread_deg = 6.0; sg.range = 40.0
	sg.auto = false; sg.recoil_scale = 2.6; sg.unlock_wave = 3
	sg.falloff_start = 6.0; sg.falloff_end = 26.0; sg.falloff_min = 0.2

	var sn := WeaponDef.new()
	sn.id = "sniper"; sn.display_name = "SNIPER"
	sn.damage = 90; sn.fire_interval = 1.2
	sn.magazine_size = 5; sn.max_reserve = 25; sn.max_reserve_cap = 60
	sn.reload_time = 3.0; sn.pellets = 1; sn.spread_deg = 0.05; sn.range = 200.0
	sn.auto = false; sn.ads_fov = 35.0; sn.recoil_scale = 3.4; sn.unlock_wave = 5
